...
def build_preamble(language, track=None):
    ...
    return (
        ...
        "OrganizingCommittee.pdf (organizing committee members and affiliations), "
        ...
        "When referencing a paper, always use its exact title as it appears in the registry."
        "Do not modify paper titles."
